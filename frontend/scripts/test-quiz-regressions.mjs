...
assert.match(appSource, /quiz: t\('quiz'\)/)
...
assert.match(apiTypesSource, /export type QuizDomain = string/)
assert.match(apiTypesSource, /domain_configs: QuizDomainConfig\[\]/)
assert.match(quizApiSource, /domainConfigs\.value = response\.domain_configs/)
assert.match(quizApiSource, /export function quizDomainLabel/)

assert.match(quizIndexSource, /quiz_pool_shortage/)
assert.match(quizIndexSource, /catalog\?\.empty_state/)
assert.match(quizIndexSource, /catalog\.value\?\.domains/)
assert.match(quizIndexSource, /quiz\.domainLabel\(domain\)/)
